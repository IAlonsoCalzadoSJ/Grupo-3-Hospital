	...
	public VistaEnviar() {
		...
		gl_panelPrincipal.setVerticalGroup(
			gl_panelPrincipal.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelPrincipal.createSequentialGroup()
					.addGroup(gl_panelPrincipal.createParallelGroup(Alignment.LEADING)
						.addComponent(panelDescripcion, GroupLayout.PREFERRED_SIZE, 108, GroupLayout.PREFERRED_SIZE)
			...
			gl_panelBotones.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelBotones.createSequentialGroup()
					...
					.addGroup(gl_panelBotones.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(botonAdjuntarArchivo, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)
			...
			gl_panelInfo.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelInfo.createSequentialGroup()
					...
					.addGroup(gl_panelInfo.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panelInfo.createSequentialGroup()
							.addComponent(labelPara, GroupLayout.DEFAULT_SIZE, 171, Short.MAX_VALUE)
							.addGap(10)
						...
						.addGroup(Alignment.LEADING, gl_panelInfo.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(fieldCabecera, GroupLayout.PREFERRED_SIZE, 1153, GroupLayout.PREFERRED_SIZE))
						.addComponent(paneCuerpo, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 1328, GroupLayout.PREFERRED_SIZE))
					.addContainerGap())
		);
		gl_panelInfo.setVerticalGroup(
			gl_panelInfo.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelInfo.createSequentialGroup()
					...
					.addGap(34)
					.addComponent(paneCuerpo, GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
					.addContainerGap())
		);
