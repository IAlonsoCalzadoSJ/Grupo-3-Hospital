	...
	public VistaSelector() {
		...
		gl_ftpPanel.setHorizontalGroup(gl_ftpPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_ftpPanel.createSequentialGroup().addContainerGap()
						...
						.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		gl_ftpPanel.setVerticalGroup(gl_ftpPanel.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
				gl_ftpPanel.createSequentialGroup().addContainerGap(43, Short.MAX_VALUE)
		...
		gl_panelMain.setHorizontalGroup(gl_panelMain.createParallelGroup(Alignment.TRAILING).addGroup(gl_panelMain
				...
				.addGroup(gl_panelMain.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelMain.createSequentialGroup().addGroup(gl_panelMain
								.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelMain.createParallelGroup(Alignment.LEADING)
										.addComponent(ftpPanel, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 505,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(mailPanel, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 505,
												GroupLayout.PREFERRED_SIZE))
								.addComponent(manualPanel, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
								.addContainerGap())
						.addGroup(
								gl_panelMain.createSequentialGroup()
										.addComponent(labelLogo, GroupLayout.PREFERRED_SIZE, 136,
												GroupLayout.PREFERRED_SIZE)
										.addGap(67))
						.addGroup(Alignment.TRAILING,
								gl_panelMain.createSequentialGroup().addComponent(volverPanel,
		...
		gl_panelMain.setVerticalGroup(gl_panelMain.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panelMain.createSequentialGroup().addContainerGap(39, Short.MAX_VALUE)
						.addComponent(volverPanel, GroupLayout.PREFERRED_SIZE, 92, GroupLayout.PREFERRED_SIZE)
						.addGap(18).addComponent(labelLogo).addPreferredGap(ComponentPlacement.UNRELATED)
		...
		gl_volverPanel.setHorizontalGroup(
				gl_volverPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_volverPanel.createSequentialGroup()
						.addComponent(botones.get(2), GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE).addGap(20)));
		gl_volverPanel
				.setVerticalGroup(gl_volverPanel.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
						gl_volverPanel.createSequentialGroup().addGap(5)
		...
		gl_manualPanel
				.setHorizontalGroup(gl_manualPanel.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
						gl_manualPanel.createSequentialGroup().addContainerGap()
								...
								.addContainerGap()));
		gl_manualPanel
				.setVerticalGroup(gl_manualPanel.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
						gl_manualPanel.createSequentialGroup().addContainerGap()
